...
void tokenizer_register_constants(INIT_FUNC_ARGS) {
	...
	REGISTER_LONG_CONSTANT("T_ESCAPING_ECHO", T_ESCAPING_ECHO, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_OPEN_TAG_WITH_ESCAPING_ECHO", T_OPEN_TAG_WITH_ESCAPING_ECHO, CONST_CS | CONST_PERSISTENT);
...
char *get_token_type_name(int token_type)
{
	switch (token_type) {
		...
		case T_ESCAPING_ECHO: return "T_ESCAPING_ECHO";
		...
		case T_OPEN_TAG_WITH_ESCAPING_ECHO: return "T_OPEN_TAG_WITH_ESCAPING_ECHO";
